  ...
  <div className="min-h-screen bg-gray-50">
    ...
    <section className="relative bg-gradient-to-br from-blue-950 via-blue-900
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        <p className="anim-shimmer text-xl font-bold mb-6">Fleet Management</p>
        <p className="text-blue-200 mb-8">Safety. Tracking. Profit. 🌊</p>

        {/* Icon stats */}
        <div className="flex justify-center gap-3 flex-wrap">
          {[["🚤","7","Features"],["🛡️","6","Safety"],["🔮","4","Coming"],["⏰","24/7","Live"]]
            .map(([i,n,l],k)=>(
            <div key={k} className="bg-white/10 border border-white/15 rounded-xl
        ...
        <ChevronDown className="mx-auto mt-8 animate-bounce text-blue-300" size={26}/>
      </div>
    </section>
    ...
    <section className="max-w-3xl mx-auto px-5 py-16">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-400 text-sm mt-1">👆 Tap to expand</p>
      </div>
    ...
    <section className="bg-gradient-to-r from-blue-900 to-cyan-800
      ...
      <h2 className="text-2xl font-bold mb-6">Protect Your Fleet Today</h2>
